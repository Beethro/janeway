...
from utils.forms import KeywordModelForm, TranslatableKeywordModelForm
...
class TransArticleInfo(TranslatableKeywordModelForm):
    ...
    def save(self, commit=True, request=None, **kwargs):
        article = super(TransArticleInfo, self).save(commit=False)
